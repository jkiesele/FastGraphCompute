...
TORCH_LIBRARY(bin_by_coordinates_func, m) {
    m.def("bin_by_coordinates_func(Tensor coords, Tensor row_splits, Tensor binswidth, Tensor nbins, bool calc_n_per_bin) -> (Tensor, Tensor, Tensor)");
}

TORCH_LIBRARY_IMPL(bin_by_coordinates_func, CUDA, m) {
    m.impl("bin_by_coordinates_func", bin_by_coordinates_cuda_interface);
}

TORCH_LIBRARY_IMPL(bin_by_coordinates_func, CPU, m) {
    m.impl("bin_by_coordinates_func", bin_by_coordinates_cpu_interface);
}